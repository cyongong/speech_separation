...
def main():
    ...
    pretrainData = LRS2Pretrain("pretrain", "/home/codud9914/s1/deep_avsr/mv3", args["PRETRAIN_NUM_WORDS"], args["CHAR_TO_INDEX"], args["STEP_SIZE"],
    ...
    prevalData = LRS2Pretrain("preval", "/home/codud9914/s1/deep_avsr/mv3", args["PRETRAIN_NUM_WORDS"], args["CHAR_TO_INDEX"], args["STEP_SIZE"],
                              audioParams, videoParams)
    prevalLoader = DataLoader(prevalData, batch_size=args["BATCH_SIZE"], collate_fn=collate_fn, shuffle=True, **kwargs)


    #declaring the model, optimizer, scheduler and the loss function
    model = AVNet(people_num=2)
    model.to(device)
