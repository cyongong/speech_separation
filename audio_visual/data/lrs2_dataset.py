...
class LRS2Pretrain(Dataset):
    ...
    def __init__(self, dataset, datadir, numWords, charToIx, stepSize, audioParams, videoParams):
    ...
    def __getitem__(self, index):
        ...
        #else:
        #    noise = None
        inp, trgt, inpLen, trgtLen = prepare_pretrain_input(audioFile, visualFeaturesFile, targetFile, self.numWords,
                                                            self.charToIx, self.audioParams, self.videoParams)
